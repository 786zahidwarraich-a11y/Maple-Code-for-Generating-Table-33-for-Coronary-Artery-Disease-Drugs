...
2. Property prediction and validation against experimental data

**Usage Instructions**
1.Run this code in Maple 2018 or later

2.No additional packages are required beyond the standard Maple library

3.Copy and paste the entire code into a Maple worksheet
...
3.Call predict_CAD_drug_properties(M_1e, M_2e, GA_e, ABC_e, chi_e, IST_e, ABL_e)

4. Replace parameters with your drug's calculated topological indices

5. Common CAD drugs include: Valsartan, Losartan, Atorvastatin, Simvastatin
